 ...
 * Run with: node src/scripts/seedProposalTemplate.js
 */
...
async function seedDefaultTemplate() {
  try {
    console.log("🌱 Seeding default proposal template...");
    ...
    const [template] = await db
      ...
      .values({
        ...
        description:
          "Professional proposal template with services table, pricing summary, and terms & conditions",
    ...
    console.log("✅ Default proposal template created successfully!");
